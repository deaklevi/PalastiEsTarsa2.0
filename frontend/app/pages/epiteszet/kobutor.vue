...
useSeoMeta({
  ...
  keywords: 'Kőbútor, asztal, kerti kőbútor, dohányzóasztal, íróasztal, étkezőasztal, gránit, márvány, mészkő'
})
</script>

<template>
    <LayoutsBaseLayout>
        <h1 class="text-2xl font-semibold mb-5">Kőbútor</h1>

        <ArchitectureCard group="kobutor"/>
