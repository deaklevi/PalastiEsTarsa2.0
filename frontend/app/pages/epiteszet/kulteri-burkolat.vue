...
useSeoMeta({
  ...
  keywords: 'Kőburkolat, kültéri burkolat, térburkolat, kockakő, homlokzat, tömb padláb, gránit, márvány, mészkő'
})
</script>

<template>
    <LayoutsBaseLayout>
        <h1 class="text-2xl font-semibold mb-5">Kültéri burkolat</h1>

        <ArchitectureCard group="kulteriburkolat"/>
