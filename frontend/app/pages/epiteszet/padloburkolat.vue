...
useSeoMeta({
  ...
  keywords: 'Belső padlóburkolat, kőburkolat, járólap, gránit, márvány, mészkő'
})
</script>

<template>
    <LayoutsBaseLayout>
        <h1 class="text-2xl font-semibold mb-5">Padlóburkolat</h1>

        <ArchitectureCard group="padloburkolat"/>
